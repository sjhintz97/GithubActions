[![Run App LastName, FirstName](https://github.com/sjhintz97/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/sjhintz97/GithubActions/actions/workflows/run-app.yaml)
